...
class player:
    ...
    def addcard(self):
        ...
        newcard = card()
        newcard.addcolor(False, r.choice(normalstuff["colors"]))
        if newcard.colors[0] != "special":
            newcard.addnumber(False, r.choice(normalstuff["numbers"]))
        elif newcard.colors[0] == "special":
            newcard.addnumber(False, r.choice(normalstuff["wilds"]))
        #FLIP
        ...
        newcard.addcolor(r.choice(normalstuff["colors"]))
        if newcard.colors[0] != "special":
            newcard.addnumber(r.choice(normalstuff["numbers"]))
        elif newcard.colors[0] == "special":
            newcard.addnumber(r.choice(normalstuff["wilds"]))
...
class card:
    ...
    def addpoints(self, isfliped, normalpoints = -1, flippoints = -1):
        if not isfliped:
            self.points[0] = normalpoints
        elif isfliped:
            self.points[1] = flippoints
