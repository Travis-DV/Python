...
class player:
    ...
    def addcard(self):
        ...
        self.normalcards += card(color, number, )
        #FLIP
...
class card:
    ...
    def __init__(self, normalcolor, normalnumber, normalpoints, flipcolor, flipnumber, flippoints):
        self.colors = [normalcolor, flipcolor]
        self.normalnumber = [normalnumber, flipnumber]
        self.normalpoints = [normalpoints, flippoints]
