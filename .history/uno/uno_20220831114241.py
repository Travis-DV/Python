...
class card:
    ...
    def addcolor(self, isflip, normalcolor = "", flipcolor =""):
        if not isflip:
            self.colors[0] = normalcolor
        pass

    def addnumber(self, isflip, normalnumber = -1, flipnumber = -1):
        pass

    def addpoints(self, isflip, flippoints = -1, normalpoints = -1):
        pass
